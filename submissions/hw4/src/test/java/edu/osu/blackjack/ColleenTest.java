...
public void cardToStringTest(){
  ...
  ********************************
  ...
  public void dealerSetDeckTest(){
    ...
    assertEquals(dealerHand.get(0).face.getValue(), Card.Face.TWO);
  }
    ...
    public void dealerDealCardTest(){
      ...
      assertEquals(deck1.get(0).face, Card.Face.QUEEN);
      Player player = new Player();
      dealer.dealCard(player);
      List<Card> deck2 = dealer.getHand();

      assertEquals(deck1.get(0).face, Card.Face.THREE);
    }
        ...
        public void dealerCompareAndSettlePlayerWinTest(){
          ...
          List<Card> playerCards= {new Card(Card.Face.TWO, Card.Suit.HEART), new Card(Card.Face.THREE, Card.Suit.DIAMOND)};
          List<Card> deck1 = dealer.getHand();
    ...
    *********************************/
    ...
    public void playerDoubltDownBetTest(){
     ...
     public void playeGetCurrentBetTest(){
      ...
      @Test
      public void moveMoneyToInsuranceInsufficientFundsTest(){
        Player player = new Player();
      ...
      @Test
      public void moveMoneyToInsuranceWithEnoughFundsTest(){
        Player player = new Player();
       ...
       public void playerMoneyToBetWithEnoughFundsTest(){
        ...
        public void playerMoneyToBetWithBadFundsTest(){
         ...
         public void playerToStringTest(){
           ...
           assertEquals(player.toString(), "QUEENHEARTw400b500i100");
          }
          ...
          public void playerNextHandTest(){
            ...
            player.moveMoneyToInsurance(100);
            player.nextHand();
            assertEquals(player.toString(), "QUEENHEARTwNULLbNULLiNULL");
           }
